defmodule Ugwu.Message.Call do
  @moduledoc """
  ...
  ```elixir
  using Ugwu.Message.Call, reply: <module>
  ```
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      @after_compile Ugwu.Message.Call
    end
  end

  alias Ecto.Changeset
  alias Ugwu.SocketHandler
  ...
  @callback changeset(struct | nil, Ugwu.json()) :: Ecto.Changeset.t()
