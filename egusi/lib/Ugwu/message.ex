defmodule Ugwu.Message do
  ...
  @type t :: %__MODULE__{
          operator: module(),
          payload: map(),
          reference: Egusi.Utils.UUID.t(),
          inbound_operator: String.t()
        }

  @spec changeset(%{String.t() => Ugwu.json()}, Ugwu.SocketHandler.state()) :: Changeset.t()
  @doc """
  ...
  @operators Ugwu.Message.Manifest.actions()
  ...
  defimpl Jason.Encoder do
    def encode(message, opts) do
      ...
      |> add_errors(message)
      |> Ugwu.Translator.translate_outbound(message)
